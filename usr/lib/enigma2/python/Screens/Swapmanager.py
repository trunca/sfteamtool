...
class Swap(Screen):
	skin = """
	<screen name="Swap" position="center,225" size="1300,720" title="Swap File Manager" flags="wfBorder" >
...
<widget name="key_yellow" position="980,655" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" transparent="1" /> 
		<widget name="key_blue" position="475,551" zPosition="1" size="140,1340" font="Regular;20" halign="center" valign="center" transparent="1" />		<widget name="autostart_off" position="10,50" zPosition="1" pixmap="skin_default/icons/lock_off.png" size="32,32" alphatest="on" />
	...
	def updateSwap2(self, result = None, retval = None, extra_args = None):
		...
		if config.plugins.swapmanager.swapautostart.value and self.swap_place:
			...
			config.plugins.swapmanager.swapautostart.value = False
			config.plugins.swapmanager.swapautostart.save()
			configfile.save()
			self['autostart_on'].hide()
			self['autostart_off'].show()
